...
const API_BASE = import.meta.env.VITE_API_BASE_URL ?? "http://72.62.197.86";
...
export default function KioskRegister() {
				...
				<div className="max-w-lg w-full text-center space-y-8">
					...
					<div className="space-y-3">
						...
						<p className="text-gray-500">
							Please visit the administration counter for verification and fee
							payment.
						</p>
					</div>
					<Button
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50">
			...
			{/* Header */}
			<div className="bg-gradient-to-r from-red-800 to-red-900 text-white py-6 px-6 shadow-lg">
				<div className="max-w-2xl mx-auto flex items-center gap-4">
					...
					<div>
						...
						<p className="text-red-200 text-sm">Student Registration Form</p>
					</div>
				</div>
			</div>
			...
			<div className="max-w-2xl mx-auto p-6 mt-6">
				<div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
					...
					<form onSubmit={handleSubmit} className="space-y-6">
						...
						<div className="space-y-2">
							...
							<Select value={referralSource} onValueChange={setReferralSource}>
								...
								<SelectContent>
									...
									<SelectItem value="banner_poster">Banner / Poster</SelectItem>
						...
						<div className="rounded-xl border border-blue-200 bg-blue-50 p-4 text-sm text-blue-800">
							<strong>Note:</strong> Fee details and class assignment will be
							finalized by the administration during your visit to the counter.
						</div>
						...
						<Button
							...
							className="w-full text-lg py-6 bg-red-800 hover:bg-red-900 rounded-xl"
						>
				...
				<p className="text-center text-sm text-gray-400 mt-6 pb-6">
					Genius Islamian's Academy — Registration Portal
				</p>
			</div>
		</div>
	);
