...
const getSourcePill = (source: string) => {
	...
	return (
		<span
			className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${styles[source] || styles["Other"]}`}
		>
			{source}
		</span>
	);
						...
						<div className="flex items-center gap-3">
							...
							<div className="text-left">
								...
								<p className="text-xs text-gray-500">
									Log a walk-in or phone inquiry
								</p>
							</div>
						</div>
						{isFormExpanded ? (
					...
					{isLoading ? (
						...
						<div className="text-center py-16">
							...
							<p className="text-sm text-gray-500">
								Add your first inquiry using the form above
							</p>
						</div>
					) : (
									...
									{leads.map((lead) => (
										...
										>
											...
											<TableCell className="py-4">
												<div className="flex items-center gap-3">
													<div
														className={`h-10 w-10 rounded-full flex items-center justify-center font-semibold text-sm ${getAvatarColor(lead.name)}`}
													>
											...
											<TableCell>
												<div className="text-sm text-gray-600">
													...
													{lead.daysSinceInquiry !== undefined &&
														lead.daysSinceInquiry > 0 && (
				...
				<AlertDialogContent className="sm:max-w-md border-2 border-red-50 shadow-2xl">
					<AlertDialogHeader>
						...
						<AlertDialogDescription className="text-gray-600 text-lg py-2">
							...
							? This will permanently delete this inquiry record from your
							pipeline.
						</AlertDialogDescription>
					</AlertDialogHeader>
