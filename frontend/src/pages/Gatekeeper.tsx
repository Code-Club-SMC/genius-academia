						...
						<div className="lg:col-span-7 space-y-8 text-white">
							...
							<div className="grid grid-cols-2 gap-6">
								<div className="bg-white/10 backdrop-blur-md rounded-3xl p-6 border border-white/20">
									<p className="text-xs font-black uppercase tracking-widest text-emerald-200 mb-2">
										Current Class
									</p>
								...
								<div className="bg-white/10 backdrop-blur-md rounded-3xl p-6 border border-white/20">
									...
									<p className="text-4xl font-mono font-black tracking-wider">
										{scanResult.student.studentId}
									</p>
							...
							{scanResult.currentSession ? (
										...
										<div className="space-y-4">
											<div className="flex items-center gap-3">
												...
												<span className="text-white/60 text-lg font-mono">
													{scanResult.currentSession.startTime} -{" "}
													{scanResult.currentSession.endTime}
												</span>
											</div>
											<h3 className="text-5xl font-black tracking-tight">
												{scanResult.currentSession.subject}
											</h3>
											<p className="text-2xl font-bold flex items-center gap-3 text-emerald-100">
												<User className="h-6 w-6" />{" "}
												{scanResult.currentSession.teacher}
											</p>
										</div>
								...
								<div className="bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10">
									<p className="text-xl font-medium text-white/60 flex items-center gap-3">
										<Clock className="h-6 w-6" /> No session scheduled for this
										time.
									</p>
								</div>
							)}
							...
							<div className="flex items-center gap-4">
								...
								<p className="text-2xl font-medium text-white/60 uppercase tracking-widest">
									Fee Status:{" "}
									<span className="text-emerald-300 font-black">CLEARED</span>
								</p>
							</div>
						</div>
					</div>
						...
						<div className="lg:col-span-7 space-y-8 text-white">
							...
							{isTooEarly ? (
								...
								<div className="bg-white/20 backdrop-blur-xl rounded-3xl p-8 border-2 border-white/30 shadow-2xl">
									<p className="text-sm font-black uppercase tracking-[0.2em] text-white/60 mb-2">
										Outstanding Balance
									</p>
	...
	return (
		...
		>
			...
			<div className="relative flex-1 flex flex-col items-center justify-center p-8">
				...
				<h1 className="text-[10rem] font-black text-white leading-none tracking-tighter drop-shadow-2xl mb-4">
					✕
				</h1>
